...
export const metadata = {
  ...
  description:
    "Drink Diary — the visual, social drink logging app for iPhone. Now available on the App Store. Log drinks, share with friends, and explore your taste over time.",
};
    ...
    <main className="w-full font-vietnam text-foreground">
      ...
      <section className="relative py-24 px-6 bg-gradient-to-br from-sage via-green to-mint overflow-hidden text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            href="https://apps.apple.com/us/app/my-drink-diary/id6761795139"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Download Drink Diary on the App Store"
            className="inline-flex items-center gap-3 bg-[#19350C] text-white font-semibold text-base px-8 py-4 rounded-2xl shadow-lg hover:bg-[#2d4a1a] hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5"
          >
