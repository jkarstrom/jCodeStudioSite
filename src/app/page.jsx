...
export default function Home() {
  return (
    <div className="min-h-screen w-screen">
      ...
      {/* NEW: Call to Action */}
      <section className="py-16 px-6 bg-gradient-to-r from-lavender via-sky to-mint text-center relative overflow-hidden">
        <div className="absolute w-32 h-32 bg-rose opacity-20 rounded-full -top-10 -left-10"></div>
        <div className="absolute w-24 h-24 bg-peach opacity-25 rounded-full -bottom-8 -right-8"></div>
        <h2 className="text-3xl md:text-4xl font-bold text-darkpurple mb-4 relative z-10">
          Let&apos;s Build Something Together
        </h2>
        <p className="text-gray-700 text-lg mb-8 max-w-xl mx-auto relative z-10">
        ...
        <a
          href="/contact"
          className="inline-block bg-darkpurple text-white font-medium px-6 py-3 rounded-lg shadow hover:bg-rose hover:text-darkpurple transition relative z-10"
        >
          Get in Touch
        </a>
      </section>
