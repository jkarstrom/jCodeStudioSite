...
export default function Home() {
  return (
    <div className="min-h-screen w-screen">
      ...
      {/* Testimonials */}
      <section className="py-20 px-6 bg-gradient-to-br from-whitepurple via-white to-powder">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-xs font-bold tracking-widest uppercase text-darkpurple/40 mb-3 font-vietnam">
              Client Reviews
            </p>
            <h2 className="text-3xl md:text-4xl font-bold text-darkpurple">What Clients Say</h2>
          </div>
