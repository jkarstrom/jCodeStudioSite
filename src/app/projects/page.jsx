          ...
          <div className="grid md:grid-cols-2 gap-10">
            {projects.map((project, index) => (
              ...
              >
                ...
                {index === 0 && (
                  <div className="absolute top-4 right-4 z-10 bg-darkpurple text-white text-xs font-bold px-3 py-1 rounded-full">
                    Featured
                  </div>
                )}

                <div className={`relative w-full ${index === 0 ? 'h-64 md:h-80' : 'h-52'} bg-gradient-to-br from-lightpurple to-pink`}>
                  <Image
                    src={project.image}
                    alt={project.title}
                    fill
                  ...
                  />
                  {/* Overlay on hover */}
                  <div className="absolute inset-0 bg-darkpurple/0 group-hover:bg-darkpurple/10 transition-colors duration-300"></div>
                </div>

                <div className="p-6">
                  <h2 className="text-xl md:text-2xl font-bold mb-2 text-black group-hover:text-darkpurple transition-colors font-vietnam">
                    {project.title}
                  </h2>
                  ...
                  {/* View Project Arrow */}
                  <div className="mt-4 flex items-center gap-2 text-darkpurple font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300">
